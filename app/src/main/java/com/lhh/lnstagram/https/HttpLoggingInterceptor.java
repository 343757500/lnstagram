...
public final class HttpLoggingInterceptor implements Interceptor {
  ...
  @Override public Response intercept(Chain chain) throws IOException {
    ...
    if (logHeaders) {
      if (hasRequestBody) {
        ...
        if (requestBody.contentType() != null) {
          stringBuffer.append("\n").append("Content-Type: " + requestBody.contentType());
        }
      ...
      if (!logBody || !hasRequestBody) {
        ...
        if (isPlaintext(buffer)) {
          ...
          stringBuffer.append("\n").append("--> END " + request.method() + " (binary "
    ...
    try {
      ...
      //LogUtil.e("Http", stringBuffer.toString());
      throw e;
    }
    ...
    if (logHeaders) {
      ...
      if (!logBody || !HttpHeaders.hasBody(response)) {
        ...
        if (gzippedLength != null) {
            stringBuffer.append("\n").append("<-- END HTTP (" + buffer.size() + "-byte, "
...
//    LogUtil.d(logTag, stringBuffer.toString());
//    LogUtil.postApiTooSlowException(url, tookMs);
